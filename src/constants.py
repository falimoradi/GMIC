...
INPUT_SIZE_DICT = {
    VIEWS.L_CC: (800, 500),  # (1400, 875),  # (2944, 1920),
    VIEWS.R_CC: (800, 500),  # (1400, 875),  # (2944, 1920),
    VIEWS.L_MLO: (800, 500),  # (1400, 875),  # (2944, 1920),
    VIEWS.R_MLO: (800, 500),  # (1400, 875),  # (2944, 1920),
}
